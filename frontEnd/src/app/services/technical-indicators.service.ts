...
export class TechnicalIndicatorsService {
  ...
  getMACD(code: string, dateFrom: string): Observable<any> {
    return this.http.get<any>(`${baseUrl}?code=${code}&dateFrom=${dateFrom}`);
  }
  
  getEMA50(code: string, dateFrom: string): Observable<any> {
    return this.http.get<any>(`${baseUrl2}?code=${code}&dateFrom=${dateFrom}`);
  }
  
  getSMA50(code: string, dateFrom: string): Observable<any> {
    return this.http.get<any>(`${baseUrl3}?code=${code}&dateFrom=${dateFrom}`);
  }
  
  getRSI(code: string, dateFrom: string): Observable<any> {
    return this.http.get<any>(`${baseUrl4}?code=${code}&dateFrom=${dateFrom}`);
  }
  ...
  getBB(code: string, dateFrom: string): Observable<any> {
    return this.http.get<any>(`${baseUrl6}?code=${code}&dateFrom=${dateFrom}`);
  }
  
  getPredictions(code: string, dateFrom: string): Observable<any> {
    return this.http.get<any>(`${baseUrl7}?code=${code}&dateFrom=${dateFrom}`);
  }
